<template>
  <div class="OutEdit flex-box flex-column">
    ...
    <div class="flex-box search-card flex-column">
      <div style="margin:0 auto;font-weight:600;font-size:24px;">出库单</div>
          ...
          <div class="ipt">
            ...
            <div style="display:flex;">
              <el-select
                ...
                placeholder="请选择"
                size="medium"
                style="margin-left:75px;height:30px;width:110px;"
              >
                <el-option
              ...
              <el-select
                ...
                placeholder="请选择"
                size="medium"
                style="height:30px;width:110px;position:absolute;left:205px;"
              >
                <el-option
                  v-for="item in options"
                  :key="item.value"
        ...
        <div class="list">
          ...
          <div class="ipt">
            ...
            <el-date-picker
              ...
              placeholder="选择日期"
              size="medium"
              style="margin-left:75px;width:240px;"
            ></el-date-picker>
          </div>
          <div class="ipt">
            <span>车牌号</span>
        ...
        <div class="list">
          ...
          <div class="ipt">
            ...
            <div style="position:absolute;left:75px;">
              <el-button type="primary">整出</el-button>
              <el-button type="success">散出</el-button>
            </div>
          </div>
        </div>
        <div class="list">
      ...
      <div style="height:40px;border:1px solid #000;width:100%;display:flex;">
        <div style="border-right:1px solid #000;height:40px;width:50px;line-height:40px;text-align:center;background:#fff;">备注</div>
        <div></div>
      </div>
      <div class="name">
        <div>
