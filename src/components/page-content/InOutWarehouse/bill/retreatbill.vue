<template>
  <div class="retreatbill flex-box flex-column">
    ...
    <div class="flex-box search-card flex-column">
      <div style="margin:0 auto;font-weight:600;font-size:24px;">退库单</div>
...
import Warehousingapproval from "@/components/page-content/InOutWarehouse/bill/dialog/Warehousingapproval";
import RetreatEdit from "@/components/page-content/InOutWarehouse/edit/RetreatEdit.vue";
