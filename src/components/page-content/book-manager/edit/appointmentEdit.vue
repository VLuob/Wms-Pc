<template>
  <div class="appointmentEdit flex-box flex-column">
    ...
    <div class="flex-box search-card flex-column">
      <div style="margin:0 auto;font-weight:600;font-size:24px;">出库预约单</div>
      ...
      <div style="height:40px;border:1px solid #000;width:100%;display:flex;">
        <div
          style="border-right:1px solid #000;height:40px;width:50px;line-height:40px;text-align:center;background:#fff;"
        >备注</div>
        <div></div>
      </div>
      <div class="name">
