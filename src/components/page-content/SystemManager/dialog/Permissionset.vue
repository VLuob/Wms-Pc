    ...
    >
      ...
      >
        <div style="display:flex;flex-direction:column;" class="box">
          <el-checkbox label="客户管理-客户列表"></el-checkbox>
          <el-checkbox label="进出库管理-进出库操作"></el-checkbox>
          <el-checkbox label="进出库管理-进出库分析"></el-checkbox>
          <el-checkbox label="费用管理-费用列表"></el-checkbox>
        </div>
        <div style="display:flex;flex-direction:column;" class="box">
          <el-checkbox label="预约管理-预约列表"></el-checkbox>
          <el-checkbox label="系统管理-用户管理-个人信息"></el-checkbox>
