 <template>
  <div class="InventorystatusView flex-box flex-column">
    <div class="flex-box search-card" style="margin-top:20px;">
      ...
      <div class="flex-grow">
        <!--  -->
        <AddVehicle :visible.sync="showAddDialog" @finish="refreshData" :edit-id="editId"></AddVehicle>
      </div>
    </div>
    <!-- 入库 -->
    <div class="list">
...
import AddVehicle from "@/components/page-content/SystemManager/dialog/AddVehicle";
