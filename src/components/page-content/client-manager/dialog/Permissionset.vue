    ...
    >
      ...
      >
        <div style="display:flex;flex-direction:column;" class="box">
          <el-checkbox label="库位信息"></el-checkbox>
          <el-checkbox label="部门主管"></el-checkbox>
          <el-checkbox label="审核状态"></el-checkbox>
        </div>
        <div style="display:flex;flex-direction:column;" class="box">
          <el-checkbox label="审核人"></el-checkbox>
          <el-checkbox label="仓库操作人"></el-checkbox>
        </div>
      </el-checkbox-group>
