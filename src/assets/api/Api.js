...
export default {
     ...
     */
    company: {
        list: ['/company/list', 'post'],//合作方列表
        add: ['/company/add', 'post'],//添加合作方
        edit: ['/company/edit', 'post'],//编辑合作方
        delete: ['/company/delete', 'post'],//删除合作方
        getById: ['/company/get_by_id', 'get'],
        selectByCategory: ['/company/select_by_category', 'get'],
        uploadFile: ['/company/uploadFile', 'post'],//上传合同
        getListById: ['/company-contract/getListById', 'post'],//查看客户合同
    },
